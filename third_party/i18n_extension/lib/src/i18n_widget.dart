...
class I18n extends StatefulWidget {
  ...
  I18n({
    ...
    Translations.supportedLocales = supportedLocales
        .map((e) => e.format())
        .toList();
  }
  ...
  ///
  @Deprecated(
    'Use `languageTag` instead, which is more standard '
  ...
  static Iterable<Locale> get supportedLocales {
    //
    var currentState = _i18nState;

    if (currentState == null) {
      throw TranslationsException(
        "Can't get I18n.supportedLocales. "
  ...
  static Iterable<LocalizationsDelegate<dynamic>> get localizationsDelegates {
    ...
    if (currentState == null) {
      throw TranslationsException(
        "Can't get I18n.localizationsDelegates. "
        "Make sure the I18n widget is in a separate parent widget, "
        "above MaterialApp/CupertinoApp in the widget tree.",
      );
    }
  ...
  ///
  static void Function({required Locale oldLocale, required Locale newLocale})
  ...
  static _I18nState of(BuildContext context) {
    _InheritedI18n? inherited = context
        .dependOnInheritedWidgetOfExactType<_InheritedI18n>();
...
class _I18nState extends State<I18n> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    if (_isResetting) {
      ...
      return _InheritedI18n(data: this, child: widget.child);
    }
  }
  ...
  @override
  void dispose() {
    if (I18n._i18nState == this) {
      I18n._i18nState = null;
    }
...
class _InheritedI18n extends InheritedWidget {
  ...
  _InheritedI18n({Key? key, required this.data, required Widget child})
