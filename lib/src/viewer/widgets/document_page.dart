...
class DocumentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final pageWidth = pageWidthTwips.twipsToPixels;
    final marginTop = marginTopTwips.twipsToPixels;
    final marginBottom = marginBottomTwips.twipsToPixels;
    final marginLeft = marginLeftTwips.twipsToPixels;
    final marginRight = marginRightTwips.twipsToPixels;

    return Container(
      width: pageWidth,
      constraints: pageHeightTwips != null
          ? BoxConstraints(minHeight: pageHeightTwips!.twipsToPixels)
          : null,
