...
// =============================================================================
// Pixel Conversions (96 DPI logical pixels for Flutter)
// =============================================================================

/// Converts DOCX integer units to Flutter logical pixels at 96 DPI.
///
/// At 96 DPI: 1 point = 96/72 ≈ 1.333 px.
extension DocxToPixels on int {
  /// Converts twips to logical pixels (1 twip = 1/20 pt × 1.333 px/pt ≈ 0.0667 px)
  double get twipsToPixels => this / 15.0;

  /// Converts EMU to logical pixels (9525 EMU = 1 px at 96 DPI)
  double get emuToPixels => this / 9525.0;

  /// Converts half-points to logical pixels (used for font sizes)
  double get halfPointsToPixels => this / 2.0;

  /// Converts eighths of a point to logical pixels (used for border widths)
  double get eighthPointsToPixels => (this / 8.0) * 1.333;

  /// Converts fiftieths-of-a-percent table width to a 0–1 fraction
  double get pctWidthToFraction => this / 5000.0;
}

extension PointsToPixels on double {
  /// Converts points to logical pixels at 96 DPI
  double get toPixels => this * 1.333;
}
